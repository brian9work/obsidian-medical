...
import { ArrowLeftFromLine, Calendar, FileText, HomeIcon, LogOut, LogOutIcon, Menu, MoveLeft, Stethoscope, User, Users } from "lucide-react"
...
export default function Home() {
   ...
   return (
      <header className="min-w-screen bg-gray-50 shadow-md">
